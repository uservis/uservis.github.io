...
glyphs.gmstar = function() {
	...
	gmstar.type = function() {
		return 'Standardized Star Glyph';
	};
	
	gmstar.isZGlyph = function() {
		return true;
	};

	
	gmstar.minZ = function(_) {
		if (!arguments.length) return minZ;
		minZ = _;
		return gmstar;
	};
	
	gmstar.maxZ = function(_) {
